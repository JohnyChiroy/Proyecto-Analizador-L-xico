    ...
    public partial class Analizador : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (contador_errores>0)
            {
                ...
                this.lbl3.Text = "ERRORES LEXICOS TIENE: " + contador_errores;
        ...
        private void btncompilar_Click(object sender, EventArgs e)
        {
            ...
            if (contador_error_compilar == 0)
            {
                ...
                using (StreamWriter writer = new StreamWriter("C:\\Cod_C#\\analizador léxico\\analizador léxico\\analizador.txt", false))
